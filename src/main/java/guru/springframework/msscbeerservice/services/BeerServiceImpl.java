...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerDto getById(UUID beerId, Boolean showInventoryOnHand) {
        if (showInventoryOnHand)
            return beerMapper.beerToBeerDtoWithInventory(beerRepository.findById(beerId).orElseThrow(EntityNotFoundException::new));
        else
            return beerMapper.beerToBeerDto(beerRepository.findById(beerId).orElseThrow(EntityNotFoundException::new));
    }
